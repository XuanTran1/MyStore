...
public class ShoppingCartItem implements java.io.Serializable
{
   ...
   private com.redhat.mystore.ShoppingCart shoppingCart;
   ...
   public com.redhat.mystore.ShoppingCart getShoppingCart()
   {
      return this.shoppingCart;
   }

   public void setShoppingCart(com.redhat.mystore.ShoppingCart shoppingCart)
   {
   ...
   public ShoppingCartItem(java.lang.String itemId, java.lang.String name,
         ...
         com.redhat.mystore.ShoppingCart shoppingCart)
   {
      this.itemId = itemId;
      this.name = name;
      this.price = price;
