...
public class ShoppingCart implements java.io.Serializable
{
   ...
   private java.util.List<com.redhat.mystore.ShoppingCartItem> shoppingCartItemList;

   public ShoppingCart()
   {
   }

   public java.util.List<com.redhat.mystore.ShoppingCartItem> getShoppingCartItemList()
   {
      return this.shoppingCartItemList;
   }

   public void setShoppingCartItemList(java.util.List<com.redhat.mystore.ShoppingCartItem> shoppingCartItemList)
   {
   ...
   public ShoppingCart(
         ...
         java.util.List<com.redhat.mystore.ShoppingCartItem> shoppingCartItemList)
   {
      this.cartItemPromoSavings = cartItemPromoSavings;
      this.cartItemTotal = cartItemTotal;
      this.cartTotal = cartTotal;
